require = function t(e, n, r) {
    ...
    22: [function(t, e, n) {
        function r(t) {
            this._requestManager = new o(t), this.currentProvider = t, this.eth = new a(this), this.db = new s(this), this.shh = new c(this), this.net = new u(this), this.personal = new f(this), this.bzz = new l(this), this.settings = new p, this.version = {
                api: h.version
            }, this.providers = {
                HttpProvider: b,
                IpcProvider: _
                ...
                function N(t, e, n, r) {
                    ...
                    if (l) {
                        t: {
                            ...
                            if (i = e - o, i < 0) i += w, a = e, c = l[u = 0], f = c / p[o - a - 1] % 10 | 0;
                    ...
                    if (f = r(f), l = r(l), p = p.slice(), u = f - l) {
                        ...
                        for (i = (s = (u = p.length) < (n = h.length)) ? u : n, u = n = 0; n < i; n++)
                            if (p[n] != h[n]) {
                                s = p[n] < h[n];
                                break
                            } if (s && (a = p, p = h, h = a, t.s = -t.s), n = (i = h.length) - (o = p.length), n > 0)
                        for (; n--; p[o++] = 0);
                    for (n = _ - 1; i > u;) {
                        if (p[--i] < h[i]) {
                            for (o = i; o && !p[--o]; p[o] = n);
