...
import "../contracts/BrooklynAnimalAction.sol";

contract TestBrooklynAnimalAction {
    function testGetShortIntro() public {
        BrooklynAnimalAction baa = new BrooklynAnimalAction();
        ...
        string memory result = baa.getShortIntro();
    ...
    function testGetAbout() public {
        ...
        string memory result = baa.getAbout();
    ...
    function testGetTnr() public {
        ...
        string memory result = baa.getTnr();
